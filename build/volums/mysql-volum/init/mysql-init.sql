...
VALUES (1, '高等数学（上）', 4, 49.50, '123456', '1.jpg', '', now(), 1, 0),
       (2, '高等数学（上）', 4, 49.50, '123456', '2.jpg', '', now(), 2, 0),
       (3, '高等数学（下）', 4, 48.50, '123456', '3.jpg', '', now(), 3, 0),
       (4, '高等数学（下）', 4, 48.50, '123456', '4.jpg', '', now(), 4, 0),
       (5, '计算机组成原理', 5, 55.50, '123456', '5.jpg', '', now(), 5, 0),
       (6, 'C语言程序设计', 5, 54.50, '123456', '6.jpg', '', now(), 6, 0),
       (7, '电工学（上）', 6, 47.50, '123456', '7.jpg', '', now(), 5, 0),
       (8, '电工学（下）', 6, 44.50, '123456', '8.jpg', '', now(), 1, 0),
       (9, '电工学（上）', 6, 47.50, '123456', '9.jpg', '', now(), 4, 0),
       (10, '电工学（下）', 4, 46.50, '123456', '10.jpg', '', now(), 6, 0),
       (11, '算法设计与分析基础', 5, 59.50, '123456', '11.jpg', '', now(), 2, 0),
       (12, '算法设计与分析基础', 5, 69.50, '123456', '12.jpg', '', now(), 3, 0),
       (13, '计算机科学概论', 5, 48.50, '123456', '13.jpg', '', now(), 1, 0),
       (14, '计算机科学概论', 5, 47.50, '123456', '14.jpg', '', now(), 2, 0),
       (15, '计算机组成原理', 5, 46.50, '123456', '15.jpg', '', now(), 5, 0),
       (16, '计算机组成原理', 5, 44.50, '123456', '16.jpg', '', now(), 1, 0),
       (17, '计算机组成原理', 5, 47.50, '123456', '17.jpg', '', now(), 3, 0),
       (18, 'C语言程序设计', 5, 39.50, '123456', '18.jpg', '', now(), 6, 0),
       (19, 'C语言程序设计', 5, 43.50, '123456', '19.jpg', '', now(), 1, 0),
       (20, 'C语言程序设计', 5, 41.50, '123456', '20.jpg', '', now(), 4, 0),
       (21, '高等数学（上）', 4, 23.50, '123456', '21.jpg', '', now(), 1, 0),
       (22, '计算机科学概论', 5, 48.50, '123456', '22.jpg', '', now(), 5, 0),
       (23, 'C语言程序设计', 4, 60.50, '123456', '23.jpg', '', now(), 2, 0),
       (24, '计算机科学概论', 5, 42.50, '123456', '24.jpg', '', now(), 2, 0),
       (25, '高等数学（上）', 4, 49.50, '123456', '25.jpg', '', now(), 3, 0),
       (26, '高等数学（下）', 4, 39.50, '123456', '26.jpg', '', now(), 6, 0),
       (27, '高等数学（下）', 4, 36.50, '123456', '27.jpg', '', now(), 4, 0)
